        ...
        <div b-fjwotxpclx="" className="main-content-inner">
          <div className="breadcrumbs" id="breadcrumbs">
            <ul className="breadcrumb">
              ...
              <li>
                <a href="/Index/Posts?type=article&amp;term=politics">
                  Article
                </a>
              </li>
            </ul>
            ...
            <div
              id="page-data"
              data-url="https://as-mangopulse-admin.azurewebsites.net/Publisher?type=article&amp;term=politics"
              data-title="Article"
            ></div>
          </div>
          <form
          ...
          >
            <div className="page-content">
              ...
              <div className="row">
                ...
                <input
                  ...
                  name="TermId"
                  type="hidden"
                  value="13e22d63-ed61-11ec-9860-30d16bee5962"
                />
                <input
                  data-val="true"
                            ...
                            <div className="col-4">
                              <div className="profile-feed">
                                <a
                                  ...
                                  data-loadtype="popup"
                                  href="/Posts/Browse?Type=article&amp;Term=politics&amp;OrderBy=CreationDate%20DESC&amp;Status=20&amp;Page=1&amp;MainRequest=True&amp;SearchRequest=False&amp;AllowedCount=-1&amp;ParentHandler=window.back.publisher&amp;ThisYear=False&amp;SubscriptionId=00000000-0000-0000-0000-000000000000"
                                >
            ...
            <input
              ...
              type="hidden"
              value="CfDJ8Gw4EJhP_tFBqoXBSpM7LZ2t3-82GmQQRlr52nEKNzoPBkVKdJJ-XSUW5r_ukKEvtvpwrFuLO_rQGkVmfm_3Ijj9hHvjx0Njl1ujvz9UQVx9OAgVWb6BQche922c-fCHzJN58dX7qcJGyktIUGrfueCaePgeoj0sjFGQIKUf7FGWIP6edJvfucLhOTXPtAHEOA"
            />
          </form>
...
export default AlnasherPolitics
