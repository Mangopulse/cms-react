...
const AlnasherFashion = () => {
  return (
    <div className="no-skin rtl make-rtl">s
      ...
      <div b-fjwotxpclx="" className="main-content-inner">
        <div className="breadcrumbs" id="breadcrumbs">
          <ul className="breadcrumb">
            ...
            <li>
              <a href="/Index/Posts?type=article&amp;term=fashion"> Article </a>
            </li>
          </ul>

          <div
            id="page-data"
            data-url="https://as-mangopulse-admin.azurewebsites.net/Publisher?type=article&amp;term=fashion"
            data-title="Article"
          ></div>
        </div>
        <form
        ...
        >
          <div className="page-content">
            ...
            <div className="row">
              ...
              <input
                ...
                name="TermId"
                type="hidden"
                value="1d1eca11-ed61-11ec-9860-30d16bee5962"
              />
              <input
                data-val="true"
                          ...
                          <div className="col-4">
                            <div className="profile-feed">
                              <a
                                ...
                                data-loadtype="popup"
                                href="/Posts/Browse?Type=article&amp;Term=fashion&amp;OrderBy=CreationDate%20DESC&amp;Status=20&amp;Page=1&amp;MainRequest=True&amp;SearchRequest=False&amp;AllowedCount=-1&amp;ParentHandler=window.back.publisher&amp;ThisYear=False&amp;SubscriptionId=00000000-0000-0000-0000-000000000000"
                              >
          ...
          <input
            ...
            type="hidden"
            value="CfDJ8Gw4EJhP_tFBqoXBSpM7LZ0yMarQFseHDKGE_0b_64fN2A5OS9Oe37IJ1zGfRBeZSGFwIBGgz6kGMS0t7j_6FT9UF1k7YnXGfRrBEY6Qf8clA1qbkKLaLO2Lo87JPtew4cBlspkaO_o_l2td38K2QQhbjwKjgnsMxeLTCbWLBu1xmDi9Y-e4GcLYD0r8GFCGNw"
          />
        </form>
...
export default AlnasherFashion
