(function(b) {
    ...
    var a = {
        ...
        _tpl_copy: '<div class="gritter-copy"></div>',
        _tpl_title: '<span class="gritter-title">[[title]]</span>',
        _tpl_item: '<div id="gritter-item-[[number]]" class="gritter-item-wrapper [[item_class]]" style="display:none"><div class="gritter-top"></div><div class="gritter-item">[[close]][[copy]][[image]]<div class="[[class_name]]">[[title]]<p>[[text]]</p><input class="details" style="display:none" value="[[details]]"></div><div style="clear:both"></div></div><div class="gritter-bottom"></div></div>',
        ...
        add: function(g) {
            ...
            i = this._str_replace(["[[title]]", "[[text]]", "[[close]]", "[[copy]]", "[[image]]", "[[number]]", "[[class_name]]", "[[item_class]]", "[[details]]"], [k, n, this._tpl_close, g.details ? this._tpl_copy : "", c, this._item_count, h, m, g.details ? g.details : ""], i);
            ...
            b(o).find(".gritter-copy").click(function () {
                $(".gritter-item input.details").show();
                $(".gritter-item input.details").select();
                document.execCommand("copy");
                $(".gritter-item input.details").hide();
            });
            return f;
        },
        ...
        _fade: function(g, d, j, f) {
            ...
            if (i) {
                g.animate({ opacity: 0 }, c, function() { g.animate({ height: 0 }, 300, function() { a._countRemoveWrapper(d, g, h); }); });
            } else {
