    ...
    <div b-fjwotxpclx="" className="main-content">
      <div b-fjwotxpclx="" className="main-content-inner">
        <div className="breadcrumbs" id="breadcrumbs">
          ...
          <div
            id="page-data"
            data-url="https://as-mangopulse-admin.azurewebsites.net/Posts/Tabs?type=article"
            data-title="Article"
          ></div>
        </div>
        <div className="page-content">
          <div className="page-header">
            ...
            <div className="page-operations">
              <a href="/Posts/Tabs?type=article" className="btn btn-new info"
                ><i className="ace-icon fa fa-sync"></i> تحديث
              </a>
              <div className="pull-left">
                <Link
                  to="/ArticlesPage"
                  className="btn btn-new pink btn-all-article"
                ...
                <div className="tabbable">
                  <ul className="nav nav-tabs" id="statustabs">
                    <li className="nav-item">
                      <a
                        className="nav-link"
                        href="/Posts/Tabs?type=article&amp;status=10"
                      >
                    ...
                    <li className="nav-item">
                      <a
                        ...
                        href="/Posts/Tabs?type=article&amp;status=20"
                      >
                    ...
                    <li className="nav-item">
                      <a
                        className="nav-link"
                        href="/Posts/Tabs?type=article&amp;status=30"
                      >
                    ...
                    <li className="nav-item">
                      <a
                        className="nav-link"
                        href="/Posts/Tabs?type=article&amp;status=-100"
                      >
                        <i className="red ace-icon fa fa-times bigger-120"></i>
                        Deleted
                      </a>
                    ...
                    <li className="nav-item">
                      <a
                        className="nav-link"
                        href="/Posts/Tabs?type=article&amp;status=-150"
                      >
                      ...
                      <div className="row">
                        <div className="col-1">
                          ...
                          >
                            ...
                            <a
                              className="nav-link"
                              href="/Posts/Tabs?type=article&amp;status=20&amp;term=sport"
                            >
                              sport
                            </a>
                            <a
                              className="nav-link"
                              href="/Posts/Tabs?type=article&amp;status=20&amp;term=entertainment"
                            >
                              Entertainment
                            </a>
                            <a
                              className="nav-link"
                              href="/Posts/Tabs?type=article&amp;status=20&amp;term=politics"
                            >
                              Politics
                            </a>
                            <a
                              className="nav-link"
                              href="/Posts/Tabs?type=article&amp;status=20&amp;term=fashion"
                            >
                              Fashion
                            </a>
                            <a
                              className="nav-link"
                              href="/Posts/Tabs?type=article&amp;status=20&amp;term=sports"
                            >
                              Sports
                            </a>
                            <a
                              className="nav-link"
                              href="/Posts/Tabs?type=article&amp;status=20&amp;term=tech"
                            >
                              Tech
                            </a>
                            <a
                              className="nav-link"
                              href="/Posts/Tabs?type=article&amp;status=20&amp;term=business"
                            >
                              Business
                            </a>
                          </div>
                          ...
                          <div className="">
                            ...
                            >
                              <div
                                ...
                                data-size="20"
                                data-moreurl="/Posts?MainRequest=False&amp;type=article&amp;Status=20"
                              >
                                  ...
                                  <tbody>
                                    ...
                                    >
                                      <td className="cell-main">
                                        ...
                                        <div className="cell-data">
                                          ...
                                          <div
                                            className="text posts-users table-metas"
                                          >
                                            <div className="posts-mod entry">
                                              29 Aug 12:45
                                            </div>
                                            <div className="posts-mod entry">
                                              آخر تعديل بواسطة techsupport في 29
                                              Aug 12:45
                                            </div>
                                      ...
                                      <td className="cell-actions">
                                        <div className="action-buttons">
                                          ...
                                          <a
                                            ...
                                            ><i
                                              className="ace-icon fa fa-share-alt"
                                            ></i>
                                            نشر
                                          </a>
                                        </div>
                                      ...
                                      <td className="cell-main">
                                        ...
                                        <div className="cell-data">
                                          ...
                                          >
                                            ...
                                            <div className="posts-mod entry">
                                              آخر تعديل بواسطة techsupport في 8
                                              Aug 12:14
                                            </div>
                                    ...
                                    >
                                      <td className="cell-main">
                                        ...
                                        <div className="cell-data">
                                          <a
                                            ...
                                            className="cell-title"
                                            >Startup adds beds and Wi-Fi to
                                            buses to turn them into ‘moving
                                            hotels’
                                          </a>
                                          <div
                                            className="text posts-users table-metas"
                                      ...
                                      <td className="hidden-480 cell-info">
                                        <a href="/Preview/author/Posts/59"
                                          >Clark Jones</a
                                        >
                                      </td>
                                      ...
                                      <td className="cell-main">
                                        ...
                                        <div className="cell-data">
                                          <a
                                            ...
                                            className="cell-title"
                                            >5 Crowdfunded products that
                                            actually delivered on the hyp
                                          </a>
                                          <div
                                            className="text posts-users table-metas"
                                          >
                                            ...
                                            <div className="posts-mod entry">
                                              آخر تعديل بواسطة techsupport في 28
                                              July 07:23
                                            </div>
                                      ...
                                      <td className="cell-main">
                                        ...
                                        <div className="cell-data">
                                          ...
                                          >
                                            ...
                                            <div className="posts-mod entry">
                                              آخر تعديل بواسطة techsupport في 10
                                              Aug 17:04
                                            </div>
                                      ...
                                      <td className="cell-main">
                                        ...
                                        <div className="cell-data">
                                          <a
                                            ...
                                            className="cell-title"
                                            >NASA seeks to build a quieter
                                            supersonic plane for passenger
                                            flight
                                          </a>
                                          <div
                                            className="text posts-users table-metas"
                                          >
                                            ...
                                            <div className="posts-mod entry">
                                              آخر تعديل بواسطة techsupport في 6
                                              July 12:01
                                            </div>
                                      ...
                                      <td className="cell-main">
                                        ...
                                        <div className="cell-data">
                                          <a
                                            ...
                                            className="cell-title"
                                            >Hulu hires Google marketing veteran
                                            Kelly Campbell as CMO
                                          </a>
                                          <div
                                            className="text posts-users table-metas"
                                          >
                                      ...
                                      <td className="cell-main">
                                        ...
                                        <div className="cell-data">
                                          <a
                                            ...
                                            className="cell-title"
                                            >Lawmaker spends a day working as
                                            baggage handler, barista
                                          </a>
                                          <div
                                            className="text posts-users table-metas"
                                          >
                                      ...
                                      <td className="cell-main">
                                        ...
                                        <div className="cell-data">
                                          <a
                                            ...
                                            className="cell-title"
                                            >Some California incumbents lagging
                                            in fundraising: report
                                          </a>
                                          <div
                                            className="text posts-users table-metas"
                                          >
                                      ...
                                      <td className="cell-main">
                                        ...
                                        <div className="cell-data">
                                          <a
                                            ...
                                            className="cell-title"
                                            >House panel to consider bill to
                                            revamp DHS cyber team
                                          </a>
                                          <div
                                            className="text posts-users table-metas"
                                          >
                                      ...
                                      <td className="cell-main">
                                        ...
                                        <div className="cell-data">
                                          <a
                                            ...
                                            className="cell-title"
                                            >Poll: Virginia governor’s race in
                                            dead heat
                                          </a>
                                          <div
                                            className="text posts-users table-metas"
                                      ...
                                      <td className="cell-main">
                                        ...
                                        <div className="cell-data">
                                          <a
                                            ...
                                            className="cell-title"
                                            >Ruth Bader Ginsburg optimistic
                                            ‘over the long haul’ for US
                                          </a>
                                          <div
                                            className="text posts-users table-metas"
                                          >
                                      ...
                                      <td className="cell-main">
                                        ...
                                        <div className="cell-data">
                                          <a
                                            ...
                                            className="cell-title"
                                            >Congress rolls out ‘Better Deal,’
                                            new economic agenda
                                          </a>
                                          <div
                                            className="text posts-users table-metas"
                                      ...
                                      <td className="cell-main">
                                        ...
                                        <div className="cell-data">
                                          <a
                                            ...
                                            className="cell-title"
                                            >Illinois’ financial crisis could
                                            bring the state to a halt
                                          </a>
                                          <div
                                            className="text posts-users table-metas"
                                          >
                                    ...
                                    <tr className="clickable-row" data-modelid="99">
                                      <td className="cell-main">
                                        <a href="/Posts/article/Preview/99">
                                          <img
                                            data-src="https://as-mangopulse-media.azurewebsites.net/store/archive/image/2022/7/1/519cbd51-bad9-40b7-a2a3-36eade86b708.jpg"
                                            src="https://as-mangopulse-media.azurewebsites.net/store/archive/image/2022/7/1/519cbd51-bad9-40b7-a2a3-36eade86b708.jpg?preset=table-thumb"
                                            className="placeholder"
                                          />
                                        </a>
                                        <div className="cell-data">
                                          <a
                                            ...
                                            className="cell-title"
                                            >Netflix was the top grossing app in
                                            Q2, with mobile revenue up 233%
                                          </a>
                                          <div
                                            className="text posts-users table-metas"
                                          >
                                            ...
                                            <div className="posts-mod entry">
                                              آخر تعديل بواسطة techsupport في 1
                                              July 07:15
                                            </div>
                                          ...
                                          <div className="text posts-media">
                                            <a
                                              href="https://as-mangopulse-front.azurewebsites.net/article/tech/99/netflix-was-the-top-grossing-app-in-q2--with-mobile-revenue"
                                              className="notajax"
                                              target="_blank"
                                              ><i
                                                className="fa fa-external-link-alt"
                                            ...
                                            ></a>
                                            <a
                                              href="/Assets/Edit/Media/709eec27-f90d-11ec-a81d-000d3aa9ccac?type=image"
                                            >
                                              <i
                                                className="purple fa fa-file-image"
                                                title="cover (Image)"
                                            ...
                                            <a
                                              href="/Assets/Edit/Media/7c546c3e-f90d-11ec-a81d-000d3aa9ccac?type=image"
                                            >
                                              <i
                                                className="purple fa fa-file-image"
                                                title="longCover (Image)"
                                      ...
                                      <td className="cell-info-main">Tech</td>
                                      <td className="hidden-480 cell-info">
                                        <a href="/Preview/author/Posts/58"
                                          >John Smith</a
                                        >
                                      </td>
                                      ...
                                      <td className="cell-actions">
                                        <div className="action-buttons">
                                          ...
                                          <a
                                            href="/Social/Publish/Share?postid=87ccd9a4-f90d-11ec-a81d-000d3aa9c700"
                                            className="btn btn-new pink"
                                            ><i
                                              className="ace-icon fa fa-share-alt"
                                            ></i>
...
export default TakseemArticles
