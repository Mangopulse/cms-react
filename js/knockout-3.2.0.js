                    ...
                    b.sb = function(b, d, m) {
                        ...
                        if (c && !g) {
                            ...
                            case "splice":
                                ...
                                for (var h = 1 === t ? h : Math.min(d + (m[1] || 0), h), t = d + t - 2, z = Math.max(h, t), u = [], r = [], E = 2; d < z; ++d,
                                ++E)
            ...
            a.d.options = {
                ...
                update: function(b, d, c) {
                    ...
                    a.a.Za(b, l, function(d, e, f) {
                        f.length && (q = f[0].selected ? [a.i.q(f[0])] : [],
                        n = !0);
