...
import { mainpage, HomeNavbar } from "../dummydata";
            ...
            <div className="main-content">
              <div className="main-content-inner">
                <div className="breadcrumbs" id="breadcrumbs">
                  ...
                  <div
                    id="page-data"
                    data-url="https://as-mangopulse-admin.azurewebsites.net/"
                    data-title=""
                  ></div>
                </div>

                <div className="welcome">
                  <h3>{val.welcome_message}</h3>
                </div>

                <div className="reload-btns">
                  <a className="btn btn-new info" href="/Home/ClearAPICache">
                    {val.mobile}
                  </a>
                  <a className="btn btn-new info"href="/Home/ClearWebsiteCache">
                    {val.location}
                  </a>
                </div>
